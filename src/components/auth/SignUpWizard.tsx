        ...
        {[1, 2, 3].map((s) => (
          <div
            ...
            className={`w-10 h-10 rounded-full flex items-center justify-center relative z-10 transition-all duration-500 ${
              step >= s
                ? "clay-gradient text-white scale-110"
                : "bg-white text-gray-400 border border-gray-100"
            }`}
          >
            {step > s ? <CheckCircle className="w-5 h-5" /> : <span>{s}</span>}
          </div>
        ))}
      </div>
      ...
      <AnimatePresence mode="wait">
        ...
        {step === 1 && (
          ...
          >
            ...
            <p className="text-gray-500 mb-8 font-light">
              Commençons par définir votre rôle sur la plateforme.
            </p>
              ...
              {[
                {
                  ...
                  desc: "À la recherche d'un logement sûr et moderne.",
                  icon: <User className="w-6 h-6" />,
                },
                {
                  id: "HOST",
                  label: "Je suis un Hôte",
                  desc: "Je propose une chambre ou un appartement.",
                ...
                >
                  <div
                    className={`w-12 h-12 rounded-2xl flex items-center justify-center ${
                      role === r.id ? "clay-gradient text-white" : "bg-gray-50 text-gray-400"
                    }`}
                  >
                    {r.icon}
                  </div>
        ...
        {step === 2 && (
          ...
          >
            <button
              onClick={prevStep}
              className="text-gray-400 hover:text-primary mb-6 flex items-center gap-1 text-sm font-medium"
            >
              <ArrowLeft className="w-4 h-4" /> Retour
            </button>
            <h2 className="text-3xl font-bold text-primary mb-2">Informations de base</h2>
            <p className="text-gray-500 mb-8 font-light">
              Vos coordonnées pour instaurer la confiance.
            </p>
            ...
            <div className="space-y-4 mb-8">
              <input
                ...
                className="w-full p-4 rounded-2xl bg-white border border-gray-100 focus:outline-none focus:ring-2 focus:ring-accent/20 transition-all font-medium"
              />
              <input
                type="email"
                name="email"
        ...
        {step === 3 && (
          ...
          >
            ...
            <p className="text-gray-500 mb-8 font-light">
              Aidez-nous à garantir une communauté sûre.
            </p>
              ...
              <div className="flex items-start gap-4 p-4 rounded-2xl bg-white border border-gray-100">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mb-3">
                    Acceptez-vous de fournir les coordonnées d&apos;un tuteur si demandé ?
                  </p>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      name="safetyQuestions.parentVisits"
                      checked={formData.safetyQuestions.parentVisits}
                      onChange={handleInputChange}
              ...
              {role === "HOST" ? (
                <div className="space-y-4">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder="Expérience en tant qu'hôte (ex : 2 ans)"
                    className="w-full p-4 rounded-2xl bg-white border border-gray-100 focus:outline-none focus:ring-2 focus:ring-accent/20 transition-all"
                  />
                  <label className="flex items-center gap-3">
                    <input
                      type="checkbox"
                      name="safetyQuestions.livesOnsite"
                      checked={formData.safetyQuestions.livesOnsite}
                      onChange={handleInputChange}
                      className="w-5 h-5 accent-accent"
                    />
                    <span className="text-xs text-gray-500 font-light">
                      Je vis sur place ou à proximité pour les urgences.
                    </span>
                  </label>
                </div>
              ) : (
                <div className="space-y-4">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder="Nom de l'université (ex : UM6P, UIK)"
                    className="w-full p-4 rounded-2xl bg-white border border-gray-100 focus:outline-none focus:ring-2 focus:ring-accent/20 transition-all"
                  />
                  <input
                    type="text"
                    ...
                    value={formData.profession}
                    onChange={handleInputChange}
                    placeholder="Filière / Niveau d'études"
                    className="w-full p-4 rounded-2xl bg-white border border-gray-100 focus:outline-none focus:ring-2 focus:ring-accent/20 transition-all"
                  />
                </div>
              )}
            ...
            >
              {loading ? "Création en cours..." : "Compléter l'inscription"}
        ...
        {(step as any) === 4 && (
          ...
          >
            ...
            <p className="text-gray-500 mb-8">
              Bienvenue sur <strong>StudentHome.ma</strong>. Votre compte est actif —
